...
export const STATES: StateInfo[] = [
  ...
  { code: 'FL', nameEn: 'Florida', nameVi: 'Florida', governor: 'Ron DeSantis', capital: 'Tallahassee', senators: ['Marco Rubio', 'Rick Scott'] },
  ...
  { code: 'IL', nameEn: 'Illinois', nameVi: 'Illinois', governor: 'JB Pritzker', capital: 'Springfield', senators: ['Dick Durbin', 'Tammy Duckworth'] },
  ...
  { code: 'MD', nameEn: 'Maryland', nameVi: 'Maryland', governor: 'Wes Moore', capital: 'Annapolis', senators: ['Ben Cardin', 'Chris Van Hollen'] },
  ...
  { code: 'MI', nameEn: 'Michigan', nameVi: 'Michigan', governor: 'Gretchen Whitmer', capital: 'Lansing', senators: ['Debbie Stabenow', 'Gary Peters'] },
  ...
  { code: 'MT', nameEn: 'Montana', nameVi: 'Montana', governor: 'Greg Gianforte', capital: 'Helena', senators: ['Steve Daines', 'Jon Tester'] },
  ...
  { code: 'NJ', nameEn: 'New Jersey', nameVi: 'New Jersey', governor: 'Phil Murphy', capital: 'Trenton', senators: ['Bob Menendez', 'Cory Booker'] },
  ...
  { code: 'OH', nameEn: 'Ohio', nameVi: 'Ohio', governor: 'Mike DeWine', capital: 'Columbus', senators: ['Sherrod Brown', 'JD Vance'] },
  { code: 'OK', nameEn: 'Oklahoma', nameVi: 'Oklahoma', governor: 'Kevin Stitt', capital: 'Oklahoma City', senators: ['James Lankford', 'Markwayne Mullin'] },
  { code: 'OR', nameEn: 'Oregon', nameVi: 'Oregon', governor: 'Tina Kotek', capital: 'Salem', senators: ['Ron Wyden', 'Jeff Merkley'] },
  { code: 'PA', nameEn: 'Pennsylvania', nameVi: 'Pennsylvania', governor: 'Josh Shapiro', capital: 'Harrisburg', senators: ['Bob Casey', 'John Fetterman'] },
  ...
  { code: 'SD', nameEn: 'South Dakota', nameVi: 'South Dakota', governor: 'Kristi Noem', capital: 'Pierre', senators: ['John Thune', 'Mike Rounds'] },
  ...
  { code: 'VA', nameEn: 'Virginia', nameVi: 'Virginia', governor: 'Glenn Youngkin', capital: 'Richmond', senators: ['Mark Warner', 'Tim Kaine'] },
  { code: 'WA', nameEn: 'Washington', nameVi: 'Washington', governor: 'Bob Ferguson', capital: 'Olympia', senators: ['Patty Murray', 'Maria Cantwell'] },
  { code: 'WV', nameEn: 'West Virginia', nameVi: 'West Virginia', governor: 'Patrick Morrisey', capital: 'Charleston', senators: ['Joe Manchin', 'Shelley Moore Capito'] },
