...
export const vi = {
  ...
  profile: {
    ...
    addressCityLabel: 'Thành phố',
    addressStateLabel: 'Tiểu bang',
    addressZipLabel: 'Zipcode',
    addressDistrictLabel: 'Khu vực bầu cử',
