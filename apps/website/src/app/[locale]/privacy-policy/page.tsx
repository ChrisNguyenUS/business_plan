      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-muted-foreground">
          ...
          <section id="voice-answers">
            ...
            <p>N400Ready lets you answer civics questions by voice. Your speech is turned into text by your browser&apos;s built-in speech service (for example, Apple in Safari or Google in Chrome), which may process the audio on its own servers under its own privacy policy. N400Ready never records or stores audio. For mock tests we store the text of each answer so we can grade the test and show you your results, and our team may review a small sample of this text to improve how answers are recognized; for practice we store only whether your answer was correct.</p>
            <p>On iPhone and iPad, while you use voice answers, the microphone stays on between questions, so Apple&apos;s speech service keeps processing audio during that time. The app uses only the answer you give when you tap the microphone (including words you had just started saying) and discards everything else without saving it. The microphone turns off after 5 minutes without a voice answer, or when you leave N400Ready. You can always answer by multiple choice instead.</p>
            <p lang="vi">N400Ready cho phép bạn trả lời câu hỏi công dân bằng giọng nói. Giọng nói được chuyển thành chữ bởi dịch vụ nhận dạng giọng nói có sẵn trong trình duyệt (ví dụ Apple trên Safari hoặc Google trên Chrome); dịch vụ này có thể xử lý âm thanh trên máy chủ của họ theo chính sách quyền riêng tư của họ. N400Ready không bao giờ ghi âm hay lưu âm thanh. Với bài thi thử, chúng tôi lưu phần chữ của từng câu trả lời để chấm bài, cho bạn xem kết quả, và nhóm của chúng tôi có thể xem lại một phần nhỏ để cải thiện việc nhận dạng câu trả lời; với phần luyện tập, chúng tôi chỉ lưu câu trả lời đúng hay sai.</p>
            <p lang="vi">Trên iPhone và iPad, khi bạn trả lời bằng giọng, micro bật suốt giữa các câu hỏi, nên dịch vụ nhận dạng của Apple vẫn xử lý âm thanh trong thời gian đó. App chỉ lấy câu trả lời bạn nói khi bấm nút micro (kể cả những chữ bạn vừa bắt đầu nói ngay trước đó) và bỏ đi mọi phần khác, không lưu lại. Micro tự tắt sau 5 phút không trả lời bằng giọng, hoặc khi bạn rời N400Ready. Bạn luôn có thể chọn trả lời trắc nghiệm.</p>
          </section>
