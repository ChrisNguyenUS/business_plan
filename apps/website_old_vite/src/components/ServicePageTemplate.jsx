...
export default function ServicePageTemplate({ title, desc, services, pricing, pricingNote, faqs, ctaText, ctaLink, badgeText, t }) {
  return (
    <div className="py-16 lg:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Services List */}
        <div className="mb-12">
          <h2 className="text-xl font-bold text-charcoal mb-6">{t('tax_services')}</h2>
        ...
        {pricing && pricing.length > 0 && (
          <div className="mb-12">
            <h2 className="text-xl font-bold text-charcoal mb-6">{t('services_pricing')}</h2>
            <div className="bg-white rounded-2xl border border-border overflow-hidden">
              {pricing.map((p, i) => (
                <div key={i} className={`flex items-center justify-between px-6 py-4 ${i < pricing.length - 1 ? 'border-b border-border' : ''}`}>
        ...
        {faqs && faqs.length > 0 && (
          <div className="mb-12">
            <h2 className="text-xl font-bold text-charcoal mb-6">{t('services_faq_title')}</h2>
